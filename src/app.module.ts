...
import { articleGeneratorConfig, browserConfig, serverConfig, wordpressConfig } from './config'
...
@Module({
  imports: [
    ConfigModule.forRoot({
      ...
      load: [serverConfig, wordpressConfig, articleGeneratorConfig, browserConfig],
